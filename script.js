...
// Счётчик до нашей встречи
const meetDate = new Date("2026-04-25");
function meetTimer() {
  const now = new Date();
...
function showFinal() {
  ...
  document.getElementById("finalText").innerText =
    "Зайчонок, спасибо, что ты есть. Я постоянно думаю о тебе! Постоянно жду встречи с тобой! Совсем скоро мы встретимся вновь осталось совсем чуть-чуть ❤️";
  setInterval(meetTimer, 1000);
  meetTimer();
}
